      ...
      <div className="nav-bar">
        <div className="responsive-box">
          ...
          <div className="menu-list-box">
            <ul className="nav-list">
              ...
              <Link to="/cart">
                <Badge badgeContent={cartItemsCount} color="success" showZero>
                  <li className={cartLinkColor} style={{marginRight: '0px'}}>
                    Cart
                  </li>
                </Badge>
              </Link>
            ...
            <Popup
              ...
              trigger={<button className="logout-btn">Logout</button>}
            >
              {close => (
                <div className="logout-popup-box">
                  ...
                  <div className="buttons-box">
                    ...
                    <button className="btn confirm" onClick={this.onLogout}>
                      Confirm
                    </button>
                  </div>
                </div>
        ...
        {this.state.menuOpen ? (
          <div className="menu-list-box">
            <ul className="nav-list">
              <Link to="/" onClick={this.onHome}>
                <li className={homeLinkColor} onClick={this.closeMenu}>
                  Home
                </li>
              </Link>
              <Link to="/cart">
